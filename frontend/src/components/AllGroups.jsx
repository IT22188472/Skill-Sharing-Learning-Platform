...
const AllGroups = ({ user }) => {
  ...
  return (
    <div className="user-info-card fixed top-[85px] left-[1240px] transform -translate-x-1/2 w-[250px] z-50 pr-2 rounded-2xl scrollbar-thin scrollbar bg-white p-6 text-left shadow-md">
      <h4 className="text-lg font-semibold mb-4">&nbsp;All Groups ({groups?.length})</h4>
  
      <button className="bg-orange-400 text-white px-4 py-2 mb-4 hover:bg-orange-500 transition duration-300 absolute top-[15px] right-8 rounded-3xl">
            ...
            {groups.slice(0, 3).map((group, index) => {
              ...
              return (
                <div
                  ...
                  className="group-card flex items-center bg-white rounded-lg p-4 shadow-md hover:shadow-xl transition duration-300 w-[210px] border-t-4 h-[65px]"
