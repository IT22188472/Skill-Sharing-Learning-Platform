...
const ContentDashboard = () => {
  ...
  return (
    <div className="w-[100%] mx-auto mt-5">
      <img src="/L.jpg" alt="Cover" className="w-full h-[250px] object-cover" />
      <h1 className="text-center text-4xl font-bold -mt-7 relative top-[50px]">
        <span className="text-red-600 relative  top-[-180px] left-[-400px]">All Courses</span>
      </h1>
      <div className="w-[90%] mx-auto mt-5">
        ...
        <div className="mb-4 d-flex">
          <input
            type="text"
            className="form-control me-2 relative top-[0px] left-[0px]"
