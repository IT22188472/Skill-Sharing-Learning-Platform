...
<<<<<<< HEAD
      <div className="min-h-screen bg-orange-50 flex justify-center items-center p-4">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">{error || "The recipe you're looking for doesn't exist or has been removed."}</p>
          <Link 
            to="/" 
      ...
      <div className="container mx-auto max-w-5xl px-4 -mt-10 relative z-10">
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 md:p-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {ingredientsList.map((ingredient, index) => (
                    <li key={index} className="flex items-center bg-orange-50 p-3 rounded-lg">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-orange-500 mr-3 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            {activeTab === 'video' && post.videoUrl && (
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Video Recipe</h2>
                ...
                <p className="text-gray-500 text-sm mt-3 text-center">
                  Watch the video tutorial to see how to prepare this recipe step by step.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h3 className="text-lg font-medium text-gray-800">Enjoy this recipe?</h3>
